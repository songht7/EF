<template>
	...
	<view class="page detail-page detail-page-mx detail-page-ef-2">
		<view class="scroll-view-item detail-block">
			...
			<view class="ef-imgs ef-imgs-center">
				<img src="../../static/ef4/br.png" class="ef-img" alt="">
			</view>
			...
			<!-- v-if="btnShow" -->
			<view class="ef-imgs ef-imgs-center">
				<img src="../../static/ef4/1.png" class="ef-img" alt="">
				<img src="../../static/ef4/2.png" class="ef-img" alt="">
				<img src="../../static/ef4/3.png" class="ef-img" alt="">
				<img src="../../static/ef4/4.png" class="ef-img" alt="">
			</view>
